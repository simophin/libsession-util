...
TEST_CASE("Contacts", "[config][contacts]") {
    ...
    CHECK_THROWS(c.set_nickname("1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890A"));
    CHECK_NOTHROW(c.set_nickname_truncated("1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890A"));
    CHECK(c.nickname == "1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890");
}
