...
TEST_CASE("Group Info settings", "[config][groups][info]") {
    ...
    CHECK_THROWS(ginfo1.set_name("1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890A"));
    ...
    CHECK(ginfo1.get_name() == "1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890");
}
